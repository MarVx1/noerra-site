...
def get_topic_emoji(topic: str) -> str:
    return {
        ...
        "dopamine":         "💊",
        "sleep":            "😴",
        # Было "😤" — в общем употреблении читается как гнев/фырканье,
        # не стресс. "😓" — холодный пот, однозначный символ стресса
        # (2026-07-16, по замечанию пользователя).
        "stress":           "😓",
        "anxiety":          "😰",
        "cognition":        "🧩",
        "neuroplasticity":  "🔄",
        "neuroscience":     "🧠",
        # Было "💭" — в тексте поста тот же символ похож на маркер
        # рассуждения/гипотезы, а не однозначно читается как тема
        # "психология". "🎭" — маски, устойчивая ассоциация с
        # поведением/эмоциями (2026-07-16).
        "psychology":       "🎭",
    }.get(topic, "📌")
